export const Pokedex: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	missingno: {
		inherit: true,
		baseStats: {hp: 33, atk: 255, def: 0, spa: 6, spd: 6, spe: 29},
	},
	bulbasaur: {
		inherit: true,
	...
	venusaur: {
		inherit: true,
		baseStats: {hp: 95, atk: 100, def: 83, spa: 102, spd: 102, spe: 85},
		types: ["Grass"],
	},
	charmander: {
		inherit: true,
	...
	charizard: {
		inherit: true,
		baseStats: {hp: 78, atk: 104, def: 78, spa: 95, spd: 95, spe: 100},
	},
	squirtle: {
		inherit: true,
	...
	blastoise: {
		inherit: true,
		baseStats: {hp: 80, atk: 70, def: 95, spa: 105, spd: 105, spe: 105},
	},
	caterpie: {
		inherit: true,
	...
	pidgeot: {
		inherit: true,
		baseStats: {hp: 83, atk: 87, def: 75, spa: 95, spd: 95, spe: 100},
	},
	rattata: {
		inherit: true,
	...
	fearow: {
		inherit: true,
		baseStats: {hp: 85, atk: 90, def: 85, spa: 115, spd: 115, spe: 100},
	},
	ekans: {
		inherit: true,
	...
	vileplume: {
		inherit: true,
		baseStats: {hp: 95, atk: 80, def: 100, spa: 105, spd: 105, spe: 50},
	},
	paras: {
		inherit: true,
	...
	arcanine: {
		inherit: true,
		baseStats: {hp: 105, atk: 135, def: 79, spa: 80, spd: 80, spe: 81},
		types: ["Fire", "Electric"],
	...
	graveler: {
		inherit: true,
		baseStats: {hp: 60, atk: 100, def: 115, spa: 45, spd: 45, spe: 35},
	},
	golem: {
		inherit: true,
		baseStats: {hp: 85, atk: 115, def: 120, spa: 75, spd: 75, spe: 55},
	},
	ponyta: {
		inherit: true,
	...
	rapidash: {
		inherit: true,
		baseStats: {hp: 65, atk: 100, def: 70, spa: 80, spd: 80, spe: 140},
	},
	slowpoke: {
		inherit: true,
		baseStats: {hp: 90, atk: 65, def: 65, spa: 55, spd: 55, spe: 15},
	},
	slowbro: {
		inherit: true,
		baseStats: {hp: 95, atk: 75, def: 110, spa: 95, spd: 95, spe: 30},
	},
	magnemite: {
		inherit: true,
	...
	grimer: {
		inherit: true,
		baseStats: {hp: 80, atk: 80, def: 65, spa: 80, spd: 80, spe: 25},
	},
	muk: {
		inherit: true,
		baseStats: {hp: 140, atk: 120, def: 65, spa: 115, spd: 115, spe: 60},
	},
	shellder: {
		inherit: true,
	...
	cloyster: {
		inherit: true,
		baseStats: {hp: 65, atk: 95, def: 180, spa: 85, spd: 85, spe: 70},
	},
	gastly: {
		inherit: true,
	...
	haunter: {
		inherit: true,
		baseStats: {hp: 45, atk: 80, def: 45, spa: 115, spd: 115, spe: 125},
	},
	gengar: {
		inherit: true,
	...
	onix: {
		inherit: true,
		baseStats: {hp: 170, atk: 60, def: 100, spa: 60, spd: 60, spe: 70},
	},
	drowzee: {
		inherit: true,
	...
	weezing: {
		inherit: true,
		baseStats: {hp: 65, atk: 90, def: 180, spa: 125, spd: 125, spe: 60},
	},
	rhyhorn: {
		inherit: true,
	...
	rhydon: {
		inherit: true,
		baseStats: {hp: 110, atk: 130, def: 120, spa: 50, spd: 50, spe: 40},
	},
	chansey: {
		inherit: true,
	...
	lapras: {
		inherit: true,
		baseStats: {hp: 150, atk: 80, def: 85, spa: 105, spd: 105, spe: 60},
		// types: ["Ice"],
	},
	ditto: {
		inherit: true,
	...
	dragonite: {
		inherit: true,
		baseStats: {hp: 91, atk: 100, def: 95, spa: 117, spd: 117, spe: 80},
	},
	mewtwo: {
		inherit: true,
