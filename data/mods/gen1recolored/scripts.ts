...
const SKIP_LASTDAMAGE = new Set([
	...
	'mimic', 'mist', 'poisongas', 'poisonpowder', 'recover', 'reflect', 'rest', 'softboiled', 'splash',
    'stunspore', 'substitute', 'supersonic', 'teleport', 'thunderwave', 'toxic', 'transform', 'withdraw',
]);

const TWO_TURN_MOVES = ['dig', 'fly', 'razorwind', 'skullbash'];
...
export const Scripts: ModdedBattleScriptsData = {
	...
	init() {
		...
		// Tauros
		this.modData('Learnsets', 'tauros').learnset.surf = ["1L1"];
		this.modData('Learnsets', 'tauros').learnset.quickattack = ["1L1"];
		// Snorlax
		this.modData('Learnsets', 'snorlax').learnset.yawn = ["1L1"];
		// Starmie
		this.modData('Learnsets', 'starmie').learnset.whirlpool = ["1L1"];
		this.modData('Learnsets', 'starmie').learnset.rollout = ["1L1"];
		// Alakazam
		...
		this.modData("Learnsets", "ninetales").learnset.psychic = ["1L1"];
		this.modData("Learnsets", "ninetales").learnset.thunderbolt = ["1L1"];
		this.modData("Learnsets", "ninetales").learnset.thunder = ["1L1"];
		this.modData("Learnsets", "ninetales").learnset.recover = ["1L1"];
		// Hypno
		this.modData("Learnsets", "hypno").learnset.lowkick = ["1L1"];
		this.modData("Learnsets", "hypno").learnset.growth = ["1L1"];
		// Moltres
		...
		// Lapras
		delete this.modData("Learnsets", "lapras").learnset.hydropump;
		this.modData("Learnsets", "lapras").learnset.dragonbreath = ["1L1"];
		// delete this.modData("Learnsets", "lapras").learnset.dragonrage;
		// Golem
		this.modData("Learnsets", "golem").learnset.rollout = ["1L1"];
		this.modData("Learnsets", "golem").learnset.agility = ["1L1"];
		this.modData("Learnsets", "golem").learnset.glare = ["1L1"];
		// Venusaur
		this.modData('Learnsets', 'venusaur').learnset.growth = ["1L1"];
		this.modData('Learnsets', 'venusaur').learnset.stunspore = ["1L1"];
		this.modData('Learnsets', 'venusaur').learnset.earthquake = ["1L1"];
		this.modData('Learnsets', 'venusaur').learnset.rockslide = ["1L1"];
		this.modData('Learnsets', 'venusaur').learnset.icebeam = ["1L1"];
		this.modData('Learnsets', 'venusaur').learnset.blizzard = ["1L1"];
		this.modData("Learnsets", "venusaur").learnset.dragonrage = ["1L1"];
		// Aerodactyl
		this.modData("Learnsets", "aerodactyl").learnset.rockslide = ["1L1"];
		this.modData("Learnsets", "aerodactyl").learnset.hurricane = ["1L1"];
		// Persian
		this.modData("Learnsets", "persian").learnset.hypnosis = ["1L1"];
		this.modData("Learnsets", "meowth").learnset.quickattack = ["1L1"];
		// Onix
		...
		this.modData("Learnsets", "magneton").learnset.magnetise = ["1L1"];
		// Gengar
		this.modData("Learnsets", "haunter").learnset.icepunch = ["1L1"];
		this.modData("Learnsets", "gengar").learnset.transform = ["1L1"];
		// Dragonite
		this.modData("Learnsets", "dragonite").learnset.dragonbreath = ["1L1"];
		// delete this.modData("Learnsets", "dragonite").learnset.dragonrage;
		// Gyarados
		this.modData("Learnsets", "gyarados").learnset.hurricane = ["1L1"];
		this.modData("Learnsets", "gyarados").learnset.dragonbreath = ["1L1"];
		this.modData("Learnsets", "gyarados").learnset.skyattack = ["1L1"];
		// Arcanine
		...
		// Slowbro
		this.modData("Learnsets", "slowbro").learnset.futuresight = ["1L1"];
		// Charizard
		this.modData("Learnsets", "charizard").learnset.hurricane = ["1L1"];
		this.modData("Learnsets", "charizard").learnset.thunderbolt = ["1L1"];
		this.modData("Learnsets", "charizard").learnset.thunder = ["1L1"];
		// Exeggutor
		this.modData('Learnsets', 'exeggutor').learnset.softboiled = ["1L1"];
		this.modData('Learnsets', 'exeggutor').learnset.rockslide = ["1L1"];
		// Vaporeon
		...
		// Raticate
		this.modData("Learnsets", "raticate").learnset.counter = ["1L1"];
		// Flareon
	...
	actions: {
			...
			if (target) {
				...
				if (moveData.boosts && target.hp) {
					...
					if (pokemon.side.foe.active[0].status) {
						...
						// If it's frozen, halve its special and quarter its speed.
						if (pokemon.side.foe.active[0].status === 'frz') {
							pokemon.side.foe.active[0].modifyStat!('spa', 0.5);
							pokemon.side.foe.active[0].modifyStat!('spd', 0.5);
							pokemon.side.foe.active[0].modifyStat!('spe', 0.25);
						}
					}
				}
				...
				if (moveData.status) {
					...
					if (moveData.status === 'slp' && target.volatiles['mustrecharge']) {
						...
						if (target.setStatus(moveData.status, pokemon, move)) {
							...
							if (moveData.status === 'frz') {
								target.modifyStat!('spa', 0.5);
								target.modifyStat!('spd', 0.5);
		...
		getDamage(source, target, move, suppressMessages) {
			...
			if ((defType === 'def' && defender.volatiles['reflect']) || (defType === 'spd' && defender.volatiles['lightscreen']) || defender.volatiles['withdraw']) {
